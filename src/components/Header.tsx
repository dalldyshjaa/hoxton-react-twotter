...
export function Header({ user }) {
  return (
    <header className="grid  px-[12px] w-[251px] h-[100vh] ">
      <div className="w-full ">
        <div className="logo-container h-[52px]">
          <div className="w-[50px] h-[50px] grid place-items-center rounded-full hover:bg-[#e8f5fd] cursor-pointer">
            <TwitterLogo />
          </div>
        </div>
        <Navitems />
      ...
      <div className="  w-full h-16  rounded-full my-3 hover:bg-[#e7e7e8]">
