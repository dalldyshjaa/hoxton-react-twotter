...
export function TwitterLogo() {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className=" text-blue-50 fill-headerPrimary w-[50px] h-[30px] "
    >
      <g>
...
export function HomeIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="nav-item  ">
      <g>
...
export function MediaImgIcon() {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      className="w-5 h-5 fill-headerPrimary cursor-pointer"
    >
      <g>
...
export function ReplyIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="post-icons">
      <g>
